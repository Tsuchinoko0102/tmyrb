class Genre
  def self.call(num)
  genre = [
                ["ビジネス・経済",[{id: 101, name: "経済・財政"},{id: 102, name: "経営"}, {id: 103, name: "流通"}, {id: 104, name: "マーケティング"},
                ...
                [ "小説・エッセイ",[{id: 201, name: "日本の小説"}, {id: 202, name: "海外の小説"}, {id: 203, name: "ミステリー・サスペンス"},
                {id: 204, name: "SF・ホラー"}, {id: 205, name: "エッセイ"}, {id: 206, name: "ノンフィクション"}, {id: 207, name: "ロマンス"},
                {id: 208, name: "ライトノベル"}, {id: 299, name: "その他小説・エッセイ"}] ],
              
                ["暮らし",[{id: 301, name: "恋愛"}, {id: 302, name: "妊娠・出産・子育て"}, {id: 303, name: "ペット"}, {id: 304, name: "住まい・インテリア"},
                ...
                ["ホビー",[{id: 401, name: "スポーツ"}, {id: 402, name: "格闘技"}, {id: 403, name: "車・バイク"}, {id: 404, name: "自転車"},
                ...
                ["旅行・留学",[{id: 501, name: "旅行"}, {id: 502, name: "温泉"}, {id: 503, name: "テーマパーク"}, {id: 504, name: "ガイドブック"},
                {id: 505, name: "地図"}, {id: 506, name: "紀行・旅行エッセイ"}, {id: 507, name: "留学・海外赴任"}, {id: 599, name: "その他旅行・留学"}]],
              
                ["語学・学習",[{id: 601, name: "英語"}, {id: 602, name: "中国語"}, {id: 603, name: "韓国語"}, {id: 604, name: "ドイツ語"}, {id: 605, name: "フランス語"},
                ...
                ["科学・技術",[{id: 701, name: "自然科学全般"}, {id: 702, name: "数学"}, {id: 703, name: "物理学"}, {id: 704, name: "化学"},
                ...
                ["PC・システム開発", [{id: 901, name: "ハードウェア"}, {id: 902, name: "インターネット・webデザイン"}, {id: 903, name: "ネットワーク"},
                ...
                ["人文・思想・社会", [{id: 1001, name: "哲学・思想"}, {id: 1002, name: "心理学"}, {id: 1003, name: "宗教・倫理"},
                ...
                ["資格試験", [{id: 1101, name: "法律関係資格"}, {id: 1102, name: "ビジネス関係資格"}, {id: 1103, name: "会計関係資格"},
